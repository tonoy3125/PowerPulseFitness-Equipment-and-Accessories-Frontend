          ...
          <div className="flex flex-col lg:flex-row gap-1 lg:gap-0 lg:justify-between items-center container mx-auto">
            ...
            >
              ...
              <NavLink to="/products" className="navlink-hover-effect">
                <p className="navlink-hover-effect pr-2 pl-2 border-r-4  border-[#ffffff]">
                  Shop
                </p>
              </NavLink>
              <p className="navlink-hover-effect pr-2 pl-2">Checkout</p>
            </div>
          </div>
        </div>
      </div>
...
export default OrderSummeryBanner;
