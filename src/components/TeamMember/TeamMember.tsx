...
const Team = () => {
  return (
    <section className="pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-20">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto mb-[60px] max-w-[510px] text-center">
              <h2 className="mb-3 text-3xl font-bold font-poppins leading-[1.2] text-dark dark:text-white sm:text-4xl md:text-[40px]">
                Our Awesome Team
              </h2>
              <p className="text-base font-poppins">
                Our Awesome Team is a group of passionate professionals, each
                bringing a wealth of knowledge, creativity, and drive to push
        ...
        <div className="-mx-4 flex flex-wrap justify-center font-lora">
          <TeamMember
            name="Coriss Ambady"
            profession="Chief Fitness Officer (CFO)"
          ...
          <TeamMember
            name="Coriss Ambady"
            profession="Product Development Manager"
