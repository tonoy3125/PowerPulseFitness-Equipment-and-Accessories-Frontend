  ...
  return (
    <div className="bg-[#F8F8F8] mt-20 mb-20">
      <div className="container mx-auto pt-10">
        ...
        <h1
          className="font-lora text-5xl text-center w-[1200px] mx-auto uppercase text-[#2C2C2C] font-bold mb-5"
        ...
        <h3
          className="font-poppins text-[#2C2C2C] text-center font-semibold text-lg uppercase mb-1"
          style={{ letterSpacing: "0.050em" }}
        >
          Peter Bowman
        </h3>
